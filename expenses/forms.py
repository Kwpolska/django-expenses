...
class ExpenseForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'vendor': forms.TextInput(attrs={'class': 'form-control expenses-addform-vendor', 'placeholder': gettext_lazy("Vendor")}),
            'amount': forms.TextInput(attrs={'class': 'form-control form-control-lg', 'type': 'number', 'step': '0.01', 'placeholder': "0.00"}),
            'description': forms.TextInput(attrs={'class': 'form-control expenses-addform-description', 'placeholder': gettext_lazy("Description")})
        }
...
class BillForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'date': forms.TextInput(attrs={'class': 'form-control', 'placeholder': gettext_lazy("Date")}),
            'vendor': forms.TextInput(attrs={'class': 'form-control expenses-billaddform-vendor', 'placeholder': gettext_lazy("Vendor")}),
...
class BillItemForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'serving': forms.TextInput(attrs={'class': 'form-control', 'type': 'number', 'step': '0.001', 'placeholder': gettext_lazy("Serving [g, L]")}),
            'count': forms.TextInput(attrs={'class': 'form-control', 'type': 'number', 'step': '0.001', 'placeholder': gettext_lazy("Count")}),
            'unit_price': forms.TextInput(attrs={'class': 'form-control form-control-lg', 'type': 'number', 'step': '0.01', 'placeholder': "0.00"})
        }
